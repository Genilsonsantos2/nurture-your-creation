        ...
        <div className="w-full max-w-[400px] space-y-8 animate-fade-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="button" disabled={submitting}
              ...
              className="w-full flex items-center justify-center gap-3 rounded-lg border border-border bg-card/50 px-4 py-2.5 text-sm font-medium text-foreground transition-all hover:bg-secondary hover:border-primary/30 disabled:opacity-50 disabled:cursor-not-allowed"
            >
