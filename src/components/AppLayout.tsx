...
import {
  ...
  AlertTriangle, ShieldCheck, Award, Video
} from "lucide-react";
...
const navSections: NavSection[] = [
  ...
  },
  {
    title: "Gestão",
    items: [
      { label: "Alunos", icon: Users, path: "/alunos", roles: ["admin", "director", "coordinator", "secretary"] },
      { label: "Turmas", icon: School, path: "/turmas", roles: ["admin", "director", "coordinator", "secretary"] },
      { label: "QR Codes", icon: QrCode, path: "/qrcodes", roles: ["admin", "director", "coordinator", "secretary"] },
      { label: "Horários", icon: Clock, path: "/horarios", roles: ["admin", "director", "coordinator"] },
    ],
  },
  {
    title: "Acesso",
    items: [
      { label: "Portaria", icon: ScanLine, path: "/portaria", roles: ["admin", "director", "coordinator", "secretary", "gatekeeper"] },
      { label: "Movimentos", icon: ArrowLeftRight, path: "/movimentacoes", roles: ["admin", "director", "coordinator", "secretary", "gatekeeper"] },
      { label: "Autorizações", icon: ShieldAlert, path: "/autorizacoes-saida", roles: ["admin", "director", "coordinator", "secretary"] },
    ],
  },
  {
    title: "Monitoramento",
    items: [
      ...
      { label: "Vídeo & IA", icon: Video, path: "/video-ia", roles: ["admin", "director", "coordinator"] },
  ...
  },
  {
    ...
    items: [
      { label: "Predição IA", icon: Brain, path: "/predicao-evasao", roles: ["admin", "director", "coordinator"] },
      { label: "Anomalias IA", icon: Shield, path: "/anomalias", roles: ["admin", "director", "coordinator"] },
      { label: "Comunicados IA", icon: FileText, path: "/comunicados", roles: ["admin", "director", "coordinator"] },
      { label: "Mapa de Calor", icon: Flame, path: "/mapa-calor", roles: ["admin", "director", "coordinator"] },
      { label: "Assistente IA", icon: Bot, path: "/assistente", roles: ["admin", "director", "coordinator", "secretary", "gatekeeper"] },
    ],
  },
  {
    title: "Sistema",
    items: [
      { label: "Relatórios", icon: BarChart3, path: "/relatorios", roles: ["admin", "director", "coordinator", "secretary"] },
      { label: "Auditoria", icon: History, path: "/auditoria", roles: ["admin", "director"] },
      { label: "Status", icon: Cpu, path: "/saude-sistema", roles: ["admin", "director"] },
      { label: "Usuários", icon: UserCog, path: "/usuarios", roles: ["admin", "director"] },
